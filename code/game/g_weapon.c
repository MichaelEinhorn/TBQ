...
void Weapon_Plasmagun_Fire (gentity_t *ent) {
	...
	VectorFill(ent->client->ps.persistant[PERS_FIREX]/((2 << 16) - 1.0f), ent->client->ps.persistant[PERS_FIREY]/((2 << 16) - 1.0f), ent->client->ps.persistant[PERS_FIREZ]/((2 << 16) - 1.0f), temp);
