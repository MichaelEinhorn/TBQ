...
/* sounds */ ""
	...
	// WEAPONS 
	//
//*****TBQ**Feb8**modified*MAR13**ADDed the HACKERGUN HERE

//QUAKED weapon_viewHack (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
{
   "weapon_hackgun",
   "sound/misc/w_pkup.wav",
   {"models/weapons2/hackergun/hackergun.md3",
   0, 0, 0}, 
   /* icon */     "icons/iconw_hackgun",   
   /* pickup */   "Temporary Breakage QKeyboard", 
			20,
			IT_WEAPON,
			WP_HACKGUN,   
   /* precache */ "",
...
/* pickup */	"Torque-ing Bladed QFist",
		0,
		IT_WEAPON,
		WP_GAUNTLET,
/* precache */ "",
...
/* pickup */	"Top-of-the-line Bomb QLauncher",
		10,
		IT_WEAPON,
		WP_GRENADE_LAUNCHER,
/* precache */ "",
...
/* pickup */	"Tube-shaped Bomb QCannon",
		10,
		IT_WEAPON,
		WP_ROCKET_LAUNCHER,
/* precache */ "",
