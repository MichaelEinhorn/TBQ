...
typedef struct {
	...
	//**TBQ**APR19**persistent zoom number
	int				persFOV;
	//*****
...
//*****TBQ**May11**adding view hack method for the game to see exists or something (i dont fully understand this part or why its necessary - c is dumb)
void CG_ViewHack( void );
void CG_ViewEnd( void );
void CG_Bird( void );
void CG_PrintHack( int HackToPrint );
//*****
