...
==================
*/
void CG_LaunchGib( vec3_t origin, vec3_t velocity, qhandle_t hModel ){ //*****TBQ**Feb23**this comment serves to remind us of the method header that didn't exist for some reason
	localEntity_t	*le;
	refEntity_t		*re;
