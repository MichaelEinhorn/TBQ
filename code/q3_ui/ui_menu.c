...
void UI_MainMenu( void ) {
	...
	s_main.multiplayer.string				= "TUSSLE";			//*****TBQ**May7**Rename "MULTIPLAYER" to "TUSSLE"
	...
	s_main.setup.string						= "BUILD";			//*****TBQ**May7**Rename "SETUP" to "BUILD"
	...
	s_main.exit.string						= "QUIT";		//*****TBQ**May7**"Exit" set to "QUIT"
	s_main.exit.color						= color_red;
	s_main.exit.style						= style;

	//Menu_AddItem( &s_main.menu,	&s_main.singleplayer );	//*****TBQ**May7**Removing this field from displaying
	Menu_AddItem( &s_main.menu,	&s_main.multiplayer );
	Menu_AddItem( &s_main.menu,	&s_main.setup );
	//Menu_AddItem( &s_main.menu,	&s_main.demos );		//*****TBQ**May7**Removing this field from displaying
	//Menu_AddItem( &s_main.menu,	&s_main.cinematics );	//*****TBQ**May7**Removing this field from displaying
	if (teamArena) {
