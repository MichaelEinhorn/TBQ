...
#define ID_CHAT2		31
//**TBQ**ID_DEFTHINGS
#define ID_GRAPPLE		32
#define ID_INCREMENT	33
#define ID_HACKMINES	34
...
//************---*************************************/
	...
	menuaction_s		chat2;
	//**TBQ**new menu items
	menuaction_s		grapple;//JAN31**grapple in menu
	menuaction_s		increment;//MAR5**hackergun increment
	menuaction_s		hackMines; //JUN1**hackmines
/************CLEANMOD********remove unneeded features
	menuaction_s		chat3;
	menuaction_s		chat4;
...
static bind_t g_bindings[] = 
{
	...
	////**TBQ**new menu items
	{"+button5", 		"grapple",			ID_GRAPPLE,		ANIM_GESTURE,	'z',		    -1,		-1, -1},//**JAN31**grapple
	{"increment", 		"cycleHack",		ID_INCREMENT,	ANIM_GESTURE,	K_MOUSE2,	    -1,		-1, -1},//**MAR5**hackergun increment
	{"hackMines", 		"hackMines",		ID_HACKMINES,	ANIM_GESTURE,	'b',			-1,		-1, -1},//**JUN1**hackmines
/************CLEANMOD********remove unneeded features
...
static menucommon_s *g_misc_controls[] = {
	...
	//**TBQ**add new binds to menu
	(menucommon_s *)&s_controls.grapple,//**JAN31**grapple in menu
	(menucommon_s *)&s_controls.increment,//**MAR5**hackergun increment
	(menucommon_s *)&s_controls.hackMines,//**JUN1**hackmines
/************CLEANMOD********remove unneeded features
...
//********************---**********************************/
	...
	//**TBQ**MAR5**cyclehack in menu
	s_controls.increment.generic.type	   = MTYPE_ACTION;
	s_controls.increment.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.increment.generic.callback  = Controls_ActionEvent;
	s_controls.increment.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.increment.generic.id        = ID_INCREMENT;
	/***/

	//**TBQ**JUN1**hackMines in menu
	s_controls.hackMines.generic.type	   = MTYPE_ACTION;
	s_controls.hackMines.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.hackMines.generic.callback  = Controls_ActionEvent;
	s_controls.hackMines.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.hackMines.generic.id        = ID_HACKMINES;
	/***/
/************CLEANMOD********remove unneeded features
...
//***************---*****************************/
	...
	Menu_AddItem( &s_controls.menu, &s_controls.grapple );//**TBQ**
	Menu_AddItem( &s_controls.menu, &s_controls.increment );//**TBQ**
	Menu_AddItem( &s_controls.menu, &s_controls.hackMines );//**TBQ**
/************CLEANMOD********remove unneeded features
